...
# ADTree classifier is now in an external Weka package which needs to be loaded manually first:
library(RWeka)
list_Weka_interfaces()
WPM("install-package", "alternatingDecisionTrees")
Sys.setenv(WEKA_HOME = "C:/Users/.../wekafiles")  ## source of Weka installation
